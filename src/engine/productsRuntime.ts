...
export function advanceProducts(rt: ProductsRuntime, c: SubContent, rivals: Company[], week: number, competition = 1, macroStrength = 0, tamGrowthMult = 1): ProductsAdvance {
